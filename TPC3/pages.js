exports.studentsListPage = function(slist, d){
    ...
    pagHTML += `
                ...
                <footer class="w3-container w3-teal">
                    <h5>Gerado por 104612::RPCW2025 em ${d} - [<a href="/">Voltar</a>]</h5>
                </footer>
            </div>
        </body>
    </html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    ...
                    <br/>
                    <button class="w3-btn w3-teal w3-mb-8 w3-round-small" type="submit">Register</button>
                </form>
    ...
    <html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <div class="w3-container">
                    <p>Welcome to the Student Management App</p>
                </div>
                <div class="w3-container w3-padding-16">
                    <a href="/alunos" >Students List</a>
                </div>
                <footer class="w3-container w3-teal">
                    <https://github.com/joaosa24h5>Gerado por 104612::RPCW2025 em ${d} - [<a href="/">Voltar</a>]</h5>
                </footer>
            </div>
        </body>
    </html>
